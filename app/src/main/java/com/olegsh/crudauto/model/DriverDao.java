...
/** 
 * DAO for table "DRIVERS".
*/
public class DriverDao extends AbstractDao<Driver, Long> {

    public static final String TABLENAME = "DRIVERS";
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"DRIVERS\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"DRIVERS\"";
        db.execSQL(sql);
    }
